  ...
  refresh() {
    $('.card').draggable({
      ...
      drag: this.throttle(function (event, ui) {
        ...
        GAME.playerBoardView.generatePlaceholder(
          ui.helper.offset().left + ui.helper.width() / 2
        )
      }, 50),
    })
