export class MinionHandView {
  ...
  update() {
    this.getElement().querySelector('.cardManaValue').innerText =
      this.minion.mana
    this.getElement().querySelector('.cardAttackValue').innerText =
      this.minion.attack
    this.getElement().querySelector('.cardHealthValue').innerText =
      this.minion.health
