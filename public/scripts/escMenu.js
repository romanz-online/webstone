...
optionsButton.onclick = function () {
  $('#optionsmenu').show()
  $('#optionsmenuContent').show().addClass('openMenuAnim')
}
...
resumeButton.onclick = function () {
  $('#gamemenuContent').removeClass('openMenuAnim').hide()
  $('#gamemenu').hide()
}
...
document.addEventListener('keydown', function (e) {
  ...
  if (document.getElementById('gamemenuContent').style.display === 'block') {
    if (
      ...
      // hide options menu
      $('#optionsmenu').hide()
      $('#optionsmenuContent').hide().removeClass('openMenuAnim')
    } else {
      // show game
      $('#gamemenuContent').removeClass('openMenuAnim').hide()
      $('#gamemenu').hide()
    ...
    // show game menu
    $('#gamemenu').show()
    $('#gamemenuContent').show().addClass('openMenuAnim')
