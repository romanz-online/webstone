...
const mainmenuOST = new Audio('../media/sounds/ost/mainmenu.mp3'),
  ...
  startTutorialSnd = new Audio(
    '../media/sounds/voiceovers/innkeeper_starttutorial.mp3'
  ),
  battlebeginSnd = new Audio(
    '../media/sounds/voiceovers/innkeeper_tutorialbattle.mp3'
  ),
  songs = [
...
;[
  ...
  howtoplaybtn,
  openpacksbtn,
  starttutorialbtn /*, backfrompackbtn*/,
  shopbtn,
].forEach((i) => {
  if (!i) {
    return
...
confirmbtn.onclick = function () {
  ...
  $('#confirm').removeClass('packHoverAnim').addClass('openPackAnim')
  ...
  setTimeout(function () {
    $('#tutorialmenu').show()
    $('#tutorialmenuContent').show().addClass('openMenuAnim')
  }, 17.925 * 1000)
...
playbtn.onclick = function () {
  ...
  crowdSnd.pause()
  $('#transitionblock').css({ visibility: 'visible' }).addClass('fadeInAnim')
  ...
  setTimeout(function () {
    $('#contents, #playerlabel, #playerclasslabel, #opponentlabel, #vs').css({
      visibility: 'visible',
    })
    new Audio('../media/sounds/ongameload.mp3').play()
    document
      .getElementById('playerHeroContainer')
      .classList.add('onLoadPlayerAnim')
    $('#opponentHeroContainer')
      .addClass('onLoadComputerAnim')
      .css({ 'z-index': 9 })
    $('#playerBubble').addClass('easeOutAnim').removeClass('openMenuAnim')
  }, 1 * 1000)
  ...
  setTimeout(function () {
    $('#playerBubble').css({ visibility: 'visible' }).addClass('openMenuAnim')
  }, 9.25 * 1000)

  setTimeout(function () {
    document.getElementById('playerBubble').style.visibility = 'hidden'
    $('#opponentBubble').css({ visibility: 'visible' }).addClass('openMenuAnim')
  }, 10.75 * 1000)

  setTimeout(function () {
    $('#opponentBubble').addClass('easeOutAnim').removeClass('openMenuAnim')
...
shopbtn.onclick = function shop() {
  ...
  $('#shopmenuContent').show().addClass('openMenuAnim')
...
starttutorialbtn.onclick = function () {
  ...
  document
    .getElementById('tutorialmenuContent')
    .classList.add('straightEaseOutAnim')

  setTimeout(function () {
    battlebeginSnd.onended = function () {
      $('#block').hide()

      GAME.playerDialogueView.setDialogueAudio(
...
document.getElementById('preventCORS').onclick = function () {
  ...
  if (isTutorial) {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        $('#transitionblock').addClass('fadeInAnim').addClass('fadeOutAnim')
      }, 1 * 1000)
  ...
  setTimeout(function () {
    $('#transitionblock').addClass('fadeInAnim, fadeOutAnim')
  }, 1 * 1000)
