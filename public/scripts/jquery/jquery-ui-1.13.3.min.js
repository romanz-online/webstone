;(function (factory) {
  ...
  ;(function () {
    ...
    $.extend(baseEasings, {
      ...
      Bounce: function (p) {
        var pow2,
          bounce = 4
        while (p < ((pow2 = Math.pow(2, (bounce -= 1))) - 1) / 11) {}
        return (
          ...
          if (!this.length && options === 'instance') {
            ...
            this.each(function () {
              ...
              if (
                ...
                return $.error(
                  "no such method '" + options + "' for button widget instance"
                )
              }
              methodValue = instance[options].apply(instance, args)
              if (methodValue !== instance && methodValue !== undefined) {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _isDisabledDatepicker: function (target) {
      ...
      for (var i = 0; i < this._disabledInputs.length; i += 1) {
  ...
  $.ui.plugin.add('draggable', 'snap', {
    ...
    drag: function (event, ui, inst) {
      ...
      for (i = inst.snapElements.length - 1; i >= 0; i -= 1) {
  ...
  $.widget('ui.resizable', $.ui.mouse, {
    ...
    _proportionallyResize: function () {
      ...
      for (; i < this._proportionallyResizeElements.length; i += 1) {
    ...
    prepareOffsets: function (t, event) {
      var i,
        ...
        list = (t.currentItem || t.element)
          .find(':data(ui-droppable)')
          .addBack()
      droppablesLoop: for (i = 0; i < m.length; i += 1) {
        if (
  ...
  var widgetsSlider = $.widget('ui.slider', $.ui.mouse, {
    ...
    _createHandles: function () {
      ...
      for (i = existingHandles.length; i < handleCount; i += 1) {
        handles.push(handle)
      }
      ...
      if (this._hasMultipleValues()) {
        ...
        if (oRange === 'max' && this.orientation === 'horizontal') {
          this.range
            ...
            [
              animate ? 'animate' : 'css'
            ]({ width: 100 - valPercent + '%' }, o.animate)
        }
        ...
        if (oRange === 'max' && this.orientation === 'vertical') {
          this.range
            ...
            [
              animate ? 'animate' : 'css'
            ]({ height: 100 - valPercent + '%' }, o.animate)
        }
      }
    },
    _handleEvents: {
  ...
  var widgetsSortable = $.widget('ui.sortable', $.ui.mouse, {
    ...
    _mouseStart: function (event, overrideHandle, noActivation) {
      ...
      $.extend(this.offset, { parent: this._getParentOffset() })
      if (o.containment) {
        this._setContainment()
      }
      ...
      if (!noActivation) {
        for (i = this.containers.length - 1; i >= 0; i -= 1) {
    ...
    cancel: function () {
      if (this.dragging) {
        ...
        for (var i = this.containers.length - 1; i >= 0; i -= 1) {
    ...
    _getItemsAsjQuery: function (connected) {
      ...
      if (connectWith && connected) {
        for (i = connectWith.length - 1; i >= 0; i -= 1) {
          cur = $(connectWith[i], this.document[0])
          for (j = cur.length - 1; j >= 0; j -= 1) {
      ...
      for (i = queries.length - 1; i >= 0; i -= 1) {
    ...
    _contactContainers: function (event) {
      ...
      if (this.containers.length === 1) {
        ...
        for (j = this.items.length - 1; j >= 0; j -= 1) {
          if (
            !$.contains(
    ...
    _clear: function (event, noPropagation) {
      ...
      if (!noPropagation) {
        for (i = 0; i < delayedTriggers.length; i += 1) {
  ...
  $.widget('ui.spinner', {
    ...
    _parse: function (val) {
      if (typeof val === 'string' && val !== '') {
        val =
          window.GAMEize && this.options.numberFormat
            ? GAMEize.parseFloat(val, 10, this.options.culture)
            : +val
      }
    ...
    _format: function (value) {
      ...
      return window.GAMEize && this.options.numberFormat
        ? GAMEize.format(value, this.options.numberFormat, this.options.culture)
        : value
    },
    _refresh: function () {
      this.element.attr({
