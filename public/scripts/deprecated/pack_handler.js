...
function onmouseup() {
  ...
  if (
    ...
    $('#packOpenAnimElem').show().addClass('packOpenAnim')

    setTimeout(function () {
      $('#packOpenAnimElem').hide().removeClass('packOpenAnim')
      $('#openpacks')
      ...
      document
        ...
        .classList.add('cardOnePackOpen')
      document
        .getElementsByClassName('flip-card')[1]
        .classList.add('cardTwoPackOpen')
      document
        .getElementsByClassName('flip-card')[2]
        .classList.add('cardThreePackOpen')
      document
        .getElementsByClassName('flip-card')[3]
        .classList.add('cardFourPackOpen')
      document
        .getElementsByClassName('flip-card')[4]
        .classList.add('cardFivePackOpen')
      for (
        let i = 0;
        i < document.getElementById('containerOpenPack').childElementCount;
        i++
      ) {
        document.getElementsByClassName('flip-card')[i].onclick = function () {
          document
            .getElementsByClassName('flip-card')
            [i].classList.add('rotate-card')
          if (
            document
              .getElementsByClassName('flip-card')
              [i].classList.contains('flip-card-common')
          ) {
            ...
            document
              .getElementsByClassName('flip-card')
              [i].classList.contains('flip-card-rare')
          ) {
            rareSnd.play()
            if (!cardflipSnd.paused) {
              overlapCardFlipSnd.play()
            ...
            document
              .getElementsByClassName('flip-card')
              [i].classList.remove('flip-card-rare')
            document.getElementById('openpacks').classList.add('rareFlipAnim')
            setTimeout(function () {
              document
                .getElementById('openpacks')
                .classList.remove('rareFlipAnim')
            }, 0.1 * 1000)
          } else if (
            document
              .getElementsByClassName('flip-card')
              [i].classList.contains('flip-card-epic')
          ) {
            epicSnd.play()
            if (!cardflipSnd.paused) {
              overlapCardFlipSnd.play()
            ...
            document
              .getElementsByClassName('flip-card')
              [i].classList.remove('flip-card-epic')
            document.getElementById('openpacks').classList.add('epicFlipAnim')
            setTimeout(function () {
              document
                .getElementById('openpacks')
                .classList.remove('epicFlipAnim')
            }, 0.15 * 1000)
          } else if (
            document
              .getElementsByClassName('flip-card')
              [i].classList.contains('flip-card-legendary')
          ) {
            legendarySnd.play()
            if (!cardflipSnd.paused) {
              overlapCardFlipSnd.play()
            ...
            document
              .getElementsByClassName('flip-card')
              [i].classList.remove('flip-card-legendary')
            document
              .getElementById('openpacks')
              .classList.add('legendaryFlipAnim')
            setTimeout(function () {
              document
                .getElementById('openpacks')
                .classList.remove('legendaryFlipAnim')
            }, 0.25 * 1000)
          }
          ...
          if (
            document
              .getElementsByClassName('flip-card')
              [i].classList.contains('rotate-card')
          ) {
            if (i == 0) {
              firstPass = true
            } else if (i == 1) {
...
function loop() {
  ...
  image.style['transform'] =
    'scale(' + scale + ') rotateY(' + ry + 'deg) rotateX(' + rx + 'deg)'
  ...
  whooshvoltarget =
    (Math.abs(opacky - packy) + Math.abs(opackx - packx)) * 0.003
