...
export default class OpponentPortrait {
  public hero: Hero
  ...
  constructor(
    ...
    // Set opponent-specific positioning
    const opponentPosition = position || new THREE.Vector3(0, OpponentPortrait.OPPONENT_Y_POSITION, Layer.HERO)
    this.hero.mesh.position.copy(opponentPosition)
